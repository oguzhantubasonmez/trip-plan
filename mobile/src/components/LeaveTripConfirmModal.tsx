...
type Props = {
  visible: boolean;
  tripTitle: string;
  /** Rota oluşturucusu sensen yönetim devri mesajı */
  isTripAdmin: boolean;
  busy: boolean;
  error: string | null;
  onClose: () => void;
...
export function LeaveTripConfirmModal(props: Props) {
      ...
      >
        ...
        >
          <View style={styles.iconWrap}>
            <Ionicons name="exit-outline" size={28} color={theme.color.primaryDark} />
          </View>
          <Text style={styles.title}>Rotadan ayrıl</Text>
          <Text style={styles.lead}>
            Bu rotadan çıktığında liste ve detayda erişimin sonlanır. Tekrar davetle eklenebilirsin.
          </Text>
          ...
          <View style={styles.infoBlock}>
            <View style={styles.infoRow}>
              ...
              <Text style={styles.infoText}>Bu rota ana sayfa ve bildirimlerde senin için kapanır; detayı açamazsın.</Text>
            </View>
            <View style={styles.infoRow}>
              <View style={styles.infoBullet} />
              <Text style={styles.infoText}>Yeniden katılmak için bir üyenin seni rotaya eklemesi gerekir.</Text>
            </View>
            {props.isTripAdmin ? (
              <View style={styles.infoRow}>
                <View style={[styles.infoBullet, styles.infoBulletAccent]} />
                <Text style={styles.infoText}>
                  Rota yöneticisisin; ayrılınca yönetim uygun bir üyeye aktarılır.
                </Text>
              </View>
            ) : null}
          </View>
